...
@Component({
  selector: 'app-duty-member',
  templateUrl: './duty-member.page.html',
  styleUrls: ['./duty-member.page.scss'],
})
export class DutyMemberPage implements OnInit {
  ...
  await this.nativeGeocoder.reverseGeocode(latitude, longitude, this.geoencoderOptions)
    .then((result: NativeGeocoderResult[]) => {
      ...
      this.logService.addLogs(this.logs).then(() => {
        this.navCtrl.navigateRoot('/duty');
        this.Sms();
